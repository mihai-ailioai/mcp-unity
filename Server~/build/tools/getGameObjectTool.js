...
const paramsSchema = z.object({
    ...
    summary: z
        .boolean()
        .optional()
        .describe("When true, returns a lightweight response with only names, instanceIds, and component type names (no property details). Useful for scanning large hierarchies."),
});
/**
